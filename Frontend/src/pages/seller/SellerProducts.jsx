              ...
              {filtered.map((product) => {
                ...
                return (
                  <tr key={product.product_id}>
                    ...
                    <td>
                      {isPaused ? (
                        <span className="status-badge status-cancelled">Paused by Admin</span>
                      ) : (
                    ...
                    <td className="table-actions">
                      {isPaused && (
                        <button
                          ...
                          style={{ color: "#b42318", fontWeight: "bold" }}
                          onClick={() => navigate(`/messages?support=admin&appeal=product&productId=${product.product_id}&productName=${encodeURIComponent(product.name)}`)}
                        >
                          Appeal Pause
                        </button>
                      )}
